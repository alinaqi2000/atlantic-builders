...
if ($_SERVER['HTTP_HOST'] != 'localhost') {
    ...
    $rating_dbname = "fusioncarmax_fusionmaxcarwash_db";
    $username_dbconn = "fusioncarmax_dev";
    $password_dbconn = 'rGQ727B-@Lo@';
    ...
    $path = "http://localhost/atlantic-builders/";
}
