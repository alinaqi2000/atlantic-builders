                        ...
                        <div class="row">
                            <div class="col-lg-12 align-self-center">
                                ...
                                <div class="slide-item-img">
                                    <img src="<?= $path ?>assets/img/slider/61.jpg" alt="#">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 align-self-center">
                                ...
                                <div class="slide-item-img">
                                    <img src="<?= $path ?>assets/img/slider/62.jpg" alt="#">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 align-self-center">
                                ...
                                <div class="slide-item-img">
                                    <img src="<?= $path ?>assets/img/slider/63.jpg" alt="#">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 align-self-center">
                                ...
                                <div class="slide-item-img">
                                    <img src="<?= $path ?>assets/img/slider/64.jpg" alt="#">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="ltn__slider-11-img-slide-arrow-inner">
                <div class="ltn__slider-11-img-slide-arrow-active">
                    <div class="image-slide-item">
                        <img src="<?= $path ?>assets/img/slider/61.jpg" alt="Flower Image">
                    </div>
                    <div class="image-slide-item">
                        <img src="<?= $path ?>assets/img/slider/62.jpg" alt="Flower Image">
                    </div>
                    <div class="image-slide-item">
                        <img src="<?= $path ?>assets/img/slider/63.jpg" alt="Flower Image">
                    </div>
                    <div class="image-slide-item">
                        <img src="<?= $path ?>assets/img/slider/64.jpg" alt="Flower Image">
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-6 align-self-center">
                <div class="about-us-img-wrap about-img-left wow animated fadeInLeft">
                    <img src="<?= $path ?>images/about.png" alt="About Us Image">
            ...
            <div class="col-lg-6 align-self-center">
                <div class="about-us-info-wrap">
                    <div class="section-title-area ltn__section-title-2--- mb-30">
                        <h6 class="section-subtitle section-subtitle-2 ltn__secondary-color wow animated fadeIn">About Us</h6>
                        <h1 class="section-title wow animated fadeInUp" data-wow-duration="1s" data-wow-delay="1s">Dream Living Spaces
                            Setting New Build</h1>
                        <p class="wow animated fadeInUp" data-wow-duration="1s" data-wow-delay="1s">Over 39,000 people work for us in more than 70 countries all over the
            ...
            <div class="col-lg-6 align-self-center">
                <div class="about-us-info-wrap">
                    <div class="section-title-area ltn__section-title-2--- mb-20">
                        <h6 class="section-subtitle section-subtitle-2--- ltn__secondary-color wow animated fadeIn">Building Facilities</h6>
                        <h1 class="section-title wow animated fadeInUp" data-wow-duration="1s" data-wow-delay="1s">Making living spaces
                            More Beautiful</h1>
                        <p class="wow animated fadeInUp" data-wow-duration="1s" data-wow-delay="1s">Over 39,000 people work for us in more than 70 countries all over the
                            This breadth of global coverage, combined with specialist services</p>
                    </div>
                    ...
                    <div class="ltn__testimoni-info">
                        ...
                        <div class="ltn__testimoni-info-inner">
                            <div class="ltn__testimoni-img">
                                <img src="<?= $path ?>assets/img/testimonial/1.jpg" alt="#">
                            </div>
            ...
            <div class="col-lg-4 wow animated zoomIn" data-wow-duration="1s" data-wow-delay="1s">
                <div class="ltn__testimonial-item ltn__testimonial-item-7">
                    <div class="ltn__testimoni-info">
                        ...
                        <div class="ltn__testimoni-info-inner">
                            <div class="ltn__testimoni-img">
                                <img src="<?= $path ?>assets/img/testimonial/2.jpg" alt="#">
                            </div>
                            <div class="ltn__testimoni-name-designation">
            ...
            <div class="col-lg-4 wow animated zoomIn" data-wow-duration="1s" data-wow-delay="1s">
                <div class="ltn__testimonial-item ltn__testimonial-item-7">
                    <div class="ltn__testimoni-info">
                        ...
                        <div class="ltn__testimoni-info-inner">
                            <div class="ltn__testimoni-img">
                                <img src="<?= $path ?>assets/img/testimonial/3.jpg" alt="#">
                            </div>
                            <div class="ltn__testimoni-name-designation">
                                <h5>Adam Joseph</h5>
                                <label>Selling Agents</label>
            ...
            <div class="col-lg-4 wow animated zoomIn" data-wow-duration="1s" data-wow-delay="1s">
                <div class="ltn__testimonial-item ltn__testimonial-item-7">
                    <div class="ltn__testimoni-info">
                        ...
                        <div class="ltn__testimoni-info-inner">
                            <div class="ltn__testimoni-img">
                                <img src="<?= $path ?>assets/img/testimonial/4.jpg" alt="#">
                            </div>
                            <div class="ltn__testimoni-name-designation">
                                <h5>James Carter</h5>
                                <label>Selling Agents</label>
