                    ...
                    <div class="col-lg-8">
                        <div class="post-details-wrapper">
                            ...
                            <div class="entry-content">
                                ...
                                <blockquote class="block-quote bg_cover mb-45" style="background-image: url(assets/images/blog/blockquote-bg.jpg);">
                            ...
                            <div class="comments-respond mb-40">
                                ...
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form_group">
                                                <input type="text" class="form_control" placeholder="Website" name="website" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form_group">
