...
--
-- Host: localhost:3306
-- Generation Time: Jul 31, 2021 at 02:43 AM
...
DROP TABLE IF EXISTS `tbl_pricing_type`;
...
DROP TABLE IF EXISTS `tbl_pri_types`;
...
(35, 26, 'image_16276677483666.jpg', '', '', 'Headlight/Taillight Bulb Replacement', 'headlight-taillight-bulb-replacement', '', '', '', 16, 1, 1);
...
--
ALTER TABLE `tbl_countvisit`
  MODIFY `visit_count_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=941;
