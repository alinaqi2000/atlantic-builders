...
--
-- Database: `fusioncarmax_fusionmaxcarwash_db`
--
...
INSERT INTO `tbl_location` (`loc_id`, `loc_type`, `loc_state`, `loc_image`, `loc_address`, `loc_city`, `loc_postcode`, `loc_phone`, `loc_status`, `loc_order`) VALUES
(1, 1, 'texas', 'image_16279934544735.png', '8331 Copper Creek LaneMissouri City,', 'Missouri City', 77459, '+(066) 517 800 628', 1, 1),
(2, 1, 'texas', NULL, '1501 E Broadway Street Pearland', 'Pearland', 77581, '+(066) 517 800 628', 1, 2),
(3, 1, 'texas', NULL, '320 W FM 544 Murphy City,', 'Murphy', 75094, '+(066) 517 800 628', 1, 3),
(4, 0, 'texas', NULL, '10300 West Grand Parkway South Richmond,', 'Harvest Green (Opening Fall 2020)', 77406, '+(066) 517 800 628', 1, 4),
(5, 0, 'texas', NULL, '14651 West Lake Houston Parkway Houston,', 'Summer Lake (Opening Fall 2020)', 77044, '+(066) 517 800 628', 1, 5),
(6, 0, 'texas', NULL, '6762 Reading Road Rosenberg,', 'Rosenberg (Opening Spring 2021)', 77471, '+(066) 517 800 628', 1, 6);
...
(1, 'PLATINUM', 34, 'Gold Wash Plus, Wheels & Tires, Clear Coat Protection, #Bug PREP, Max Cuba Wax, Fusion Bath', 1, 1),
(2, 'GOLD', 29, 'Gold Wash Plus, Wheels & Tires, Clear Coat Protection, Bug PREP, Max Cuba Wax, Fusion Bath', 1, 2),
(3, 'SILVER', 24, 'Gold Wash Plus, Wheels & Tires, Clear Coat Protection, Bug PREP, Max Cuba Wax, Fusion Bath', 1, 3),
(4, 'BRONZE', 19, 'Gold Wash Plus, Wheels & Tires, Clear Coat Protection, Bug PREP, Max Cuba Wax, Fusion Bath', 1, 4),
(5, 'PLATINUM', 25, 'Gold Wash Plus, Wheels & Tires, Clear Coat Protection, Bug PREP, Max Cuba Wax, Fusion Bath', 1, 5),
(6, 'GOLD', 20, 'Gold Wash Plus, Wheels & Tires, Clear Coat Protection, Bug PREP, Max Cuba Wax, Fusion Bath', 1, 6),
(7, 'SILVER', 15, 'Gold Wash Plus, Wheels & Tires, Clear Coat Protection, Bug PREP, Max Cuba Wax, Fusion Bath', 1, 7),
(8, 'BRONZE', 10, 'Gold Wash Plus, Wheels & Tires, Clear Coat Protection, Bug PREP, Max Cuba Wax, Fusion Bath', 1, 8),
(13, 'FULL SERVICE WASH', 55, 'Gold Wash Plus, Wheels & Tires, Clear Coat Protection, Bug PREP, Max Cuba Wax, Fusion Bath', 1, 13),
(14, 'FULL SERVICE WASH', 35, 'Gold Wash Plus, Wheels & Tires, Clear Coat Protection, Bug PREP, Max Cuba Wax, Fusion Bath', 1, 14);
...
--
ALTER TABLE `tbl_visitadmins`
  MODIFY `visit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
