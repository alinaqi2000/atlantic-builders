        ...
        <div class="mdk-drawer-layout__content page">
            <div class="container-fluid  page__heading-container">
                <div class="page__heading">
                    <h4 class="m-0"><i class="fa fa-file-alt"></i> Manage Content <i class="fa fa-chevron-right"></i> Testimonials Section</h4>
                </div>
            </div>
                            ...
                            <div class="card card-form">
                                <div class="row no-gutters">
                                    <div class="col-lg-10 offset-1 card-form__body card-body">
                                        ...
                                        <?= formText('Testimonial Title', 'title', $data['title']); ?>
                                        <?= formText('Testimonial Secondary Title', 'sec_title', $data['sec_title']); ?>

                                        <?php formImageFile('Testimonial Image', 'image', $data['image'], '600px x 450px') ?>
                                    </div>
