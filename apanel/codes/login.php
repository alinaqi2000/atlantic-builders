...
// login visitor Data Starts
        ...
        // echo 'User Real IP - '.getUserIpAddr();exit;
        $ip_address = getUserIpAddr();
        $id = $_SESSION['admin_id'];
        $vals['visit_admin_id']=$id;
        $vals['visit_ip_address']=$ip_address;
        saveRecord('tbl_visitadmins', $vals);
// login visitor Data Ends
        redirectTo('apanel/index');
    } else {
